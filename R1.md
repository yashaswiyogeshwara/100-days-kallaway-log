## Log of Round 1 of #100DaysOfCode  - done in Dec 2017
...
For using the api in ASP.Net the nuget package have to be installed which are currently not supporting in the visual studio.
